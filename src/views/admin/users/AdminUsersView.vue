...
onBeforeUnmount(() => { requestId += 1; clearTimeout(searchTimer) })
</script>
...
<template>
  <section class="users-view">
    ...
    <DataTable v-else :value="users" scrollable scroll-height="clamp(18rem, 52vh, 38rem)" striped-rows responsive-layout="scroll" class="users-table" empty-message="目前沒有符合條件的帳號。">
      ...
      <Column header="操作"><template #body><button type="button" class="detail-button" disabled title="帳號詳細功能將於下一階段提供">查看</button></template></Column>
    </DataTable>
