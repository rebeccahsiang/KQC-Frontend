...
import { crmApi, type BusinessCaseListItem, type CalendarItem, type CustomerListItem, type MyBusinessSummary } from '@/api/crm'
...
@media(max-width:767px){.my-business{gap:13px}.page-header{flex-direction:column}.header-actions{display:grid;width:100%;grid-template-columns:1fr 1fr}.header-actions .p-button:last-child{grid-column:1/-1}.surface-card{padding:14px}.kpi-grid{grid-template-columns:1fr}.calendar-list article{grid-template-columns:4.5rem 7px 1fr}.desktop-table{display:none}.mobile-cards{display:grid;gap:9px}.section-header{align-items:center}.timeline li{grid-template-columns:3rem 10px 1fr}}
</style>
