...
.state-message { padding: 3rem; text-align: center; color: #94a3b8; }.review-price { margin: 1rem 0 0; color: #fde68a; }.review-context dl { display: grid; grid-template-columns: 1fr 1fr; gap: .8rem; margin: 0; div { padding: .75rem; border-radius: .55rem; background: #0f172a; } dt { color: #94a3b8; font-size: .75rem; } dd { margin: .25rem 0 0; overflow-wrap: anywhere; } }
