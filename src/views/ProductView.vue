...
.product-toolbar { display: grid; margin-bottom: 1rem; align-items: center; grid-template-columns: minmax(0, 1fr) auto minmax(0, 1fr); gap: 1rem; }.product-toolbar p { margin: 0 0 .25rem; color: #97701c; font-size: var(--public-type-body-small, .58rem); font-weight: 850; letter-spacing: .12em; }.title-row { display: flex; align-items: center; gap: .55rem; h2 { margin: 0; font-size: var(--public-type-card-title, 1.3rem); } span { padding: .14rem .45rem; border: 1px solid #d9e1e8; border-radius: 999px; color: #6b7787; background: #fff; font-size: var(--public-type-body-small, .63rem); } }.filter-tabs { display: flex; flex-wrap: wrap; max-width: 100%; padding: .22rem; overflow-x: auto; justify-self: center; border: 1px solid #d7e0e7; border-radius: .5rem; background: #e9eef2; }.filter-tabs button { min-height: var(--public-control-sm); padding: .35rem .7rem; border: 0; border-radius: .36rem; color: #657286; background: transparent; font: inherit; font-size: var(--public-type-action, .68rem); font-weight: 750; white-space: nowrap; cursor: pointer; }.filter-tabs button.active { color: #fff; background: #213148; }.filter-tabs button:focus-visible { outline: 2px solid #b78118; outline-offset: -2px; }
/* PRODUCT-SHOWCASE-UI-R4A — Compact Consultant Entry / header action replaces the former large workspace CTA. */
.consultant-entry { display: flex; min-height: 2.8rem; padding: .4rem .6rem; align-items: center; justify-self: end; gap: .55rem; border: 1px solid #b8cbd4; border-radius: .55rem; color: #24455a; background: #fff; box-shadow: 0 4px 12px rgba(25,72,91,.05); text-decoration: none; }.consultant-entry > svg { width: 1rem; height: 1rem; flex: 0 0 1rem; color: #247188; }.consultant-entry span { display: grid; gap: .08rem; }.consultant-entry strong { font-size: var(--public-type-action, .7rem); line-height: 1.25; }.consultant-entry small { color: #718093; font-size: var(--public-type-caption, .58rem); line-height: 1.25; }.consultant-entry:hover { border-color: #247188; background: #f7fbfc; }.consultant-entry:focus-visible { outline: 3px solid rgba(36,113,136,.25); outline-offset: 2px; }
@media (max-width: 1280px) { .product-toolbar { grid-template-columns: minmax(0, 1fr) auto; }.filter-tabs { grid-row: 2; grid-column: 1 / -1; justify-self: start; } }
...
@media (max-width: 520px) { .hero-copy h1 { font-size: var(--public-type-display); }.demand-entry { padding: .65rem; align-items: stretch; flex-direction: column; }.demand-action { min-height: 2.8rem; border-radius: .35rem; justify-content: center; }.hero-visual { min-height: 13rem; }.public-total { right: .7rem; bottom: .7rem; }.marketplace-sidebar { max-height: 13rem; } }
