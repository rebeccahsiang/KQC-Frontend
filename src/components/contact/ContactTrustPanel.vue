...
.trust-panel{position:sticky;top:6.5rem;display:grid;padding:1.5rem;gap:.75rem;border-radius:1rem;color:#fff;background:linear-gradient(145deg,#152c42,#1b5b69);box-shadow:0 16px 35px rgba(15,43,58,.14)}.trust-panel>p{margin:0;color:#e2bd5d;font-size: var(--public-type-body-small, .75rem);font-weight:900;letter-spacing:.13em}.trust-panel h2{margin:0;color:#fff;font-size: var(--public-type-card-title, 1.4rem);}.trust-panel>span{color:#e0edf1;font-size: var(--public-type-body, 1rem);line-height:1.7}.trust-panel ul{display:grid;margin:.75rem 0;padding:0;gap:1rem;list-style:none}.trust-panel li{display:flex;gap:.7rem}.trust-panel li>svg{width:1.25rem;height:1.25rem;flex:0 0 auto;color:#e2bd5d}.trust-panel li div{display:grid;gap:.2rem}.trust-panel li strong{color:#fff;font-size: var(--public-type-card-title, 1rem);}.trust-panel li small{color:#d5e5ea;font-size: var(--public-type-caption, .94rem);line-height:1.55}.contact-methods{display:grid;gap:.65rem}.phone-support,.line-support{border-radius:.7rem;background:#fff}.phone-support{display:flex;padding:1rem;align-items:flex-start;gap:.7rem;color:#1d3449}.phone-support>svg{width:1.3rem;height:1.3rem;flex:0 0 auto;color:#247188}.phone-support div{display:grid;gap:.2rem}.phone-support strong,.line-support strong{color:#1d3449;font-size: var(--public-type-card-title, 1rem);}.phone-support a{width:max-content;color:#17657b;font-size: var(--public-type-body, 1.15rem);font-weight:850;text-decoration:none}.phone-support small,.line-support small{color:#68788b;font-size: var(--public-type-caption, .9rem);line-height:1.5}.phone-support a:focus-visible{outline:3px solid rgba(36,113,136,.3);outline-offset:3px}.line-support{display:flex;padding:1rem;align-items:center;justify-content:space-between;gap:.75rem;color:#1d3449}.line-support div{display:grid;gap:.25rem}.line-support img{width:7rem;height:7rem;object-fit:contain}@media(max-width:900px){.trust-panel{position:static}.contact-methods{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}}@media(max-width:600px){.contact-methods{grid-template-columns:1fr}}@media(max-width:480px){.line-support{align-items:flex-start;flex-direction:column}.line-support img{align-self:center}}
</style>
