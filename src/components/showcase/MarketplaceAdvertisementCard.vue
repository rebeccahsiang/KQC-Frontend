...
.advertisement-card__body { z-index:1; display:grid; align-content:end; gap:.65rem; padding:1rem; }.advertisement-card h3,.advertisement-card p { margin:0; }.advertisement-card h3 { font-size: var(--public-type-card-title, 1.15rem); line-height:1.35; }.advertisement-card__body > p { color:#0f172a; font-size: var(--public-type-body-small, .8rem); line-height:1.65; }
.advertisement-card__cta { justify-self:start; display:inline-flex; min-height:2.35rem; padding:.5rem .85rem; align-items:center; border-radius:999px; color:#fff; background:#1d718e; font-size: var(--public-type-body-small, .76rem); font-weight:800; text-decoration:none; }.advertisement-card__cta:hover { background:#155b74; }.advertisement-card__cta:focus-visible { outline:3px solid rgb(29 113 142 / 38%); outline-offset:3px; }
...
.advertisement-card--tone-white h3 { color:#fff; }.advertisement-card--tone-dark h3 { color:var(--advertisement-dark-copy); }.advertisement-card--tone-brand-gold h3 { color:#c99b3d; }.advertisement-card--tone-brand-blue h3 { color:#4b9bd8; }.advertisement-card--tone-brand-green h3 { color:#42a57a; }
