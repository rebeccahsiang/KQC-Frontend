...
.advertisement-card__body { z-index:1; display:grid; align-content:end; gap:.65rem; padding:1rem; }.advertisement-card h3,.advertisement-card p { margin:0; }.advertisement-card h3 { font-size:1.15rem; line-height:1.35; }.advertisement-card__body > p { color:#0f172a; font-size:.8rem; line-height:1.65; }
