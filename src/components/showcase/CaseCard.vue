...
.card-media { position: relative; overflow: hidden; aspect-ratio: 16 / 9; background: #e8edf2; }.card-image { width: 100%; height: 100%; display: block; object-fit: cover; transition: transform .32s ease; }.case-card:hover .card-image { transform: scale(1.035); }.media-tone { position: absolute; inset: 0; pointer-events: none; background: linear-gradient(to top, rgba(15,23,42,.38), transparent 48%); }.case-card--buy .media-tone { background: linear-gradient(135deg, rgba(20, 96, 119, .34), rgba(15,23,42,.08) 62%, rgba(255,255,255,.08)); }.card-image-placeholder { display: grid; width: 100%; height: 100%; place-content: center; gap: .25rem; color: #536175; background: linear-gradient(135deg, #f4f6f8, #dfe5eb); text-align: center; span { font-weight: 900; letter-spacing: .15em; } small { font-size: var(--public-type-caption, .7rem); } }.case-card--buy .card-image-placeholder { color: #236078; background: repeating-linear-gradient(-45deg, #edf8fa, #edf8fa 14px, #e2f1f4 14px, #e2f1f4 28px); }
.transaction-badge { position: absolute; left: .8rem; bottom: .7rem; display: inline-flex; min-height: var(--public-control-sm, 1.8rem); padding: .2rem .55rem .2rem .25rem; align-items: center; gap: .4rem; border-radius: .4rem; color: #fff; background: color-mix(in srgb, var(--market-accent) 90%, #111827); font-size: var(--public-type-action, .72rem); font-weight: 800; box-shadow: 0 3px 10px rgba(15,23,42,.2); }.transaction-code { padding: .15rem .3rem; border-radius: .25rem; color: var(--market-accent); background: #fff; font-size: var(--public-type-action, .62rem); letter-spacing: .04em; }
.card-body { display: flex; flex: 1; flex-direction: column; gap: .55rem; padding: .75rem; }.identity-row { display: flex; align-items: center; justify-content: space-between; gap: .55rem; }.case-number { overflow: hidden; color: #64748b; font: var(--public-type-metadata, .61rem) 'Courier New', monospace; letter-spacing: .02em; text-overflow: ellipsis; white-space: nowrap; }.category { color: var(--market-accent); font-size: var(--public-type-body-small, .64rem); font-weight: 800; white-space: nowrap; }.card-title { display: -webkit-box; min-height: 2.7em; margin: 0; overflow: hidden; color: #172033; font-size: var(--public-type-card-title, .88rem); line-height: 1.35; -webkit-box-orient: vertical; -webkit-line-clamp: 2; }.market-meta { display: flex; overflow: hidden; flex-wrap: wrap; gap: .25rem .45rem; color: #64748b; font-size: var(--public-type-caption, .62rem); line-height: 1.35; span:not(:last-child)::after { content: '·'; margin-left: .45rem; color: #c1c8d1; } }
.need-block { padding: .5rem .55rem; border-left: 2px solid var(--market-accent); border-radius: 0 .35rem .35rem 0; background: var(--market-soft); }.need-label { display: block; margin-bottom: .18rem; color: var(--market-accent); font-size: var(--public-type-caption, .56rem); font-weight: 850; letter-spacing: .06em; }.need-block p { display: -webkit-box; min-height: 2.5em; margin: 0; overflow: hidden; color: #536175; font-size: var(--public-type-body-small, .66rem); line-height: 1.45; -webkit-box-orient: vertical; -webkit-line-clamp: 2; }
.card-footer { display: flex; flex-wrap: wrap; margin-top: auto; padding-top: .55rem; align-items: flex-end; justify-content: space-between; gap: .45rem; border-top: 1px solid #edf0f3; }.price-block { display: flex; min-width: 0; flex-direction: column; gap: .12rem; span { color: #64748b; font-size: var(--public-type-body-small, .56rem); } strong { display: -webkit-box; overflow: hidden; color: #172033; font-size: var(--public-type-card-title, .72rem); line-height: 1.25; -webkit-box-orient: vertical; -webkit-line-clamp: 2; } }.intent-link { display: inline-flex; min-height: var(--public-control-sm); padding: .5rem .75rem; align-items: center; justify-content: center; flex: 0 0 auto; border: 1px solid var(--market-accent); border-radius: .36rem; color: #fff; background: var(--market-accent); font: inherit; font-size: var(--public-type-action, .64rem); font-weight: 800; white-space: nowrap; cursor: pointer; &:hover { filter: brightness(1.08); } &:focus-visible { outline: 3px solid color-mix(in srgb, var(--market-accent) 30%, transparent); outline-offset: 2px; } }
/* PRODUCT-SHOWCASE-UI-R4D — CaseCard Typography Readability / existing selectors and clamps own the desktop readability polish. */
.case-number, .category { font-size: var(--public-type-body-small, .8125rem); }
.card-title { font-size: var(--public-type-card-title, 1.125rem); }
.market-meta { font-size: var(--public-type-caption, .875rem); line-height: 1.5; }
.need-label { font-size: var(--public-type-caption, .8125rem); }
.need-block p { font-size: var(--public-type-body-small, .875rem); line-height: 1.7; }
.price-block span { font-size: var(--public-type-body-small, .8125rem); }
.price-block strong { font-size: var(--public-type-card-title, .90625rem); font-weight: 800; line-height: 1.3; }
