...
<template>
  ...
  <section class="marketplace-process-info" aria-labelledby="marketplace-process-info-title">
    ...
    <section class="process-panel" aria-labelledby="application-process-title">
      <!-- PRODUCT-SIDEBAR-R4F-3 — Transfer Process Heading Anchor / the stable hash begins at the visible process title. -->
      <header id="transfer-process" class="transfer-process-anchor"><span>TRANSFER PROCESS</span><h3 id="application-process-title">申請流程</h3><p>依序完成資料準備與主管機關變更程序。</p></header>
...
@media (max-width: 640px) { .transfer-process-anchor { scroll-margin-top: 5rem; } }
