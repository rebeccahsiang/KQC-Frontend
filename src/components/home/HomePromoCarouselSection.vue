...
const placeholderPromos: PromoItem[] = [
  { id: 'transport-services', category: '產業服務', title: '交通運輸業買賣與服務', description: '快速了解現有服務與商用車相關資訊。', imageUrl: localImage('freight-truck.png'), imageAlt: '行駛中的大型貨運車輛', target: '/products' },
  { id: 'advisor-services', category: '顧問協助', title: '專業顧問服務', description: '從需求整理到流程說明，找到適合的協助入口。', imageUrl: localImage('container-truck.png'), imageAlt: '貨櫃運輸車輛與物流場景', target: '/contact' },
  { id: 'digital-services', category: '數位服務', title: '產業資訊數位化', description: '透過公開資料與平台工具掌握產業動向。', imageUrl: localImage('light-truck.png'), imageAlt: '城市道路上的商用小貨車', target: '/company' }
]
...
<template>
  <section id="featured-services" class="home-promo-section" aria-labelledby="home-promo-title">
    ...
    <Swiper
      ...
      :watch-overflow="true"
      :grab-cursor="true"
      :breakpoints="{ 641: { slidesPerView: 2, spaceBetween: 18 }, 768: { slidesPerView: 3, spaceBetween: 20 } }"
    >
