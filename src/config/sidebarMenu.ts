...
export const sidebarMenu: SidebarMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      { id: 'marquee', title: '跑馬燈', icon: 'lucide:megaphone', path: '/admin/frontend/marquee', capabilities: ['PLATFORM_MANAGER', 'ADMIN'] },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'case-create', title: '商品案件', icon: 'lucide:layers-plus', path: '/admin/cases/create', capabilities: ['SALES', 'SALES_SUPERVISOR', 'ADMIN'] },
