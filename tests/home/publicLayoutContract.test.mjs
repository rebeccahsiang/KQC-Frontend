...
test('header exposes responsive navigation and neutral utility foundations', () => {
  ...
  assert.doesNotMatch(header, /\{ name: '擐?', path: '\/' \}/)
  ...
  assert.match(header, /class="control-btn bell-btn"/)
...
test('footer supports accessible collapse and retains legal entries', () => {
