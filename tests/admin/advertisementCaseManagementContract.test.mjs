...
test('shared visual renderer supports exactly three layouts, three typography styles, and five text tones', () => {
  ...
  assert.match(preview, /tone-dark\s*\{\s*--advertisement-dark-copy:#0f172a/)
  assert.match(preview, /tone-dark \.advertisement-preview__copy[^}]*tone-dark \.advertisement-preview__copy h3[^}]*tone-dark \.advertisement-preview__copy p[^}]*color:var\(--advertisement-dark-copy\)/)
  ...
  assert.match(preview, /overlay-left::after[^}]*overlay-center::after[^}]*linear-gradient\(180deg,transparent 10%,rgb\(3 12 24 \/ 80%\)/)
